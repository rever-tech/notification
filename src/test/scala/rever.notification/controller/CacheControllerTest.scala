package rever.notification.controller
...
import rever.notification.Server
import rever.notification.domain.UserID
import rever.notification.domain.thrift.{TUserID, TUserInfo}
import rever.notification.service.TUserCacheService.FinagledClient
import rever.notification.service.{TUserCacheService, UserCacheService}
